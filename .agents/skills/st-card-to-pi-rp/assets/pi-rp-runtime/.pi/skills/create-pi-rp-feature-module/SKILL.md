...
8. Choose `contextOrder` for model behavior and `displayOrder` for Web presentation. Module surface and browser settings never alter Agent context order.
