...
export async function execute({ run, workspace, conversation, data }) {
  ...
  operations.push(
    ...
    { operationId: `${operationId}-state`, moduleId: "world-narrative-coordinator", collectionId: "deep-workbench", recordType: "director.deep-state", action: "update", targetId: state.id, expectedRevision: state.revision, data: { ...current, status: "idle", currentRunId: null, currentChildRunId: null, lastCompletedTurn: run.turn, lastCompletedWorldTime: report.basisWorldTime ?? null, currentReportRevision: deepReport.revision + 1, failure: null }, note: null },
